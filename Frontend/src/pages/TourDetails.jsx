...
const TourDetails = () => {
  ...
  const [reviews, setReviews] = useState(tour?.reviews || []); // Manage reviews state
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      // Optionally reset the review message and rating
                    ...
                    <div className="d-flex align-items-center gap-3 mb-4 rating__group">
                      {Array.from({ length: 5 }, (_, index) => (
                        <span
                          ...
                          className={tourRating === index + 1 ? 'selected' : ''}
                        >
